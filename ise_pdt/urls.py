...
urlpatterns = [
    ...
    url(r'^reportdefect$', views.report_defect, name='report_defect'),
    ...
    url(r'^manager/(?P<username>[a-zA-Z0-9]{3,20})/(?P<project_id>[0-9]+)/nextiteration/$', views.next_iteration_m, name='next_iteration_m'),
